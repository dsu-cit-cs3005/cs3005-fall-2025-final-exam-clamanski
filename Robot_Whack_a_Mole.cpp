...
class Robot_Whack_a_Mole : public RobotBase 
{
private:
...
public:
    Robot_Whack_a_Mole() : RobotBase(2, 5, hammer) {} // Initialize with 2 movement, 5 armor, hammer
...
// Factory function to create Robot_Whack_a_Mole
extern "C" RobotBase* create_robot() 
{
    return new Robot_Whack_a_Mole();
}